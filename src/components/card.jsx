...
export default function Card({poster,date,title,paraghraf}) {
  return (
    <>
      <div className="max-w-[370px] mx-auto my-3 bg-white hover:shadow-lg flex flex-col justify-evenly cursor-pointer items-start px-5 py-8 box-border font-roboto gap-3 sm:w-auto">
           <img src={poster} alt="" />
