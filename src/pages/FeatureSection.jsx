...
export default function FeatureSection() {
  return (
    <div className="w-full h-screen text-slate-800 font-roboto flex flex-col pb-20 pt-20">
      ...
      <div className="container m-auto justify-between items-center flex-col h-full grid grid-cols-2 lg:flex lg:flex-row lg:justify-evenly">
